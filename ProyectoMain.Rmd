...
EXPLICAR POR QUÉ NO HEMOS UTILIZADO ÁRBOLES DE DECISIÓN
Se ha intentado realizar diferentes modelos de árbol de decisión, sin embargo, en todos no ha sido posible correrlos ya que no contamos con la capacidad computacional necesaria para completarlo, por esta razón se implementará el método por support vector machine.

## Predicción por medio de Support Vector Machine 
