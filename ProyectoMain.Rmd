...
knitr::opts_knit$set(root.dir="C:/Users/Andree/Documents/GitHub/ProyectoMineriaDatos")
```
...
```{r  Determinacion optima del numero de cluster, echo=FALSE}
fviz_nbclust(datosMatrimonio, kmeans, method = "gap_stat")
```


```{r cluster jerarquico, echo=FALSE}

clarax <- clara(datosMatrimonio, 3)
# Cluster plot
...
```{r Evaluacion de la tendencia de agrupamiento, echo=FALSE}

datosMatrimonio <- scale(iris[, -5])
get_clust_tendency(datosMatrimonio, n = 50,
